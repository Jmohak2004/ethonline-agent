...
const AGENT_DATA: Record<string, any> = {
  ...
  "riskguardian": {
    ...
    longDescription: "RiskGuardian is the mandatory safety gatekeeper of Gotrade. No trade can ever execute without passing RiskGuardian's confidential checks. It verifies max trade limits, portfolio exposure, daily loss thresholds, and triggers Ledger hardware clear-signing whenever limits are exceeded.",
...
function getAgentData(rawId: string) {
  ...
  return {
    ...
    category: "ONCHAIN",
    description: "Specialized AI agent operating within the Gotrade verifiable economy.",
    longDescription: `${formattedName} is an active AI agent registered on the Gotrade smart contract registry. It communicates via Hedera x402 micropayment channels and operates strictly under the RiskGuardian fail-closed safety invariant.`,
    developer: "0x71C...49bE (Verified Developer)",
    version: "1.0.0",
    rating: 4.8,
    ratingCount: 42,
