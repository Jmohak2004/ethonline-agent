...
async def create_permission(
    ...
    perm = Permission(
        ...
        agent_id=agent.id,
        max_transaction=payload.max_transaction_amount,
        daily_limit=payload.daily_spending_limit,
        daily_spent=0.0,
    ...
    return {
        ...
        "max_transaction_amount": perm.max_transaction,
        "daily_spending_limit": perm.daily_limit,
        ...
        "permissions": [
            {
                ...
                "agent_slug": a.slug,
                "ens_name": a.ens_name,
                "max_transaction_amount": p.max_transaction,
                "daily_spending_limit": p.daily_limit,
                "current_daily_spent": p.daily_spent,
